...
loader.load('easy_level landscape/textures/scene.gltf', function (gltf) {
...
var render = function () {
	if (!player1Dead && !player2Dead) {
		...
		if (flag == true && p1fireRate == 60 && Key.isDown(Key.SHIFT)) {
			//create bullet
		...
		if (flag == false && p2fireRate == 60 && Key.isDown(Key.FSLASH)) {
			//create bullet
