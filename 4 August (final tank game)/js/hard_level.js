...
function addGround() {
    var woodTex = THREE.ImageUtils.loadTexture('../textures/ice-background-2.jpg');
...
function addWalls() {
    for (var i = 0; i < 30; i++) {
		walls.push(new THREE.Mesh(new THREE.BoxGeometry(250, 250, 250), new THREE.MeshLambertMaterial( {map: THREE.ImageUtils.loadTexture('../textures/cube.jpg')} )));
	...
	loader.load('scene.gltf',function(gltf){
		...
		landscape.scale.set(20000,20000,20000);
		landscape.position.set(500,4890,0);
...
scene.background = new THREE.ImageUtils.loadTexture('skyblue');
...
//console.log("win");
		...
		if (flag==true && p1fireRate == 60 && Key.isDown(Key.SHIFT)) {
			...
			document.getElementById("c1").innerHTML ="BULLETS " + count;
...
document.getElementById("c2").innerHTML = "BULLETS  " + count2;
